...
export const authenticationTranslations = defineResourceTranslations({
  'zh-CN': {
    ...
    reauth: {
      ...
      actionObjectStorageConnectionCreate: '首次配置对象存储连接',
      actionObjectStorageConnectionReplace: '替换对象存储位置',
      actionObjectStorageConnectionRotate: '轮换对象存储凭据',
      actionObjectStorageConnectionDelete: '删除对象存储连接',
      actionObjectStorageConnectionRecover: '恢复对象存储凭据',
  ...
  en: {
    ...
    reauth: {
      ...
      actionObjectStorageConnectionCreate: 'Set up the Object Storage Connection',
      actionObjectStorageConnectionReplace: 'Replace the Object Storage Connection location',
      actionObjectStorageConnectionRotate: 'Rotate the Object Storage Connection credential',
      actionObjectStorageConnectionDelete: 'Delete the Object Storage Connection',
      actionObjectStorageConnectionRecover: 'Recover the Object Storage Connection credential',
