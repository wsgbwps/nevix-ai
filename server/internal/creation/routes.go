...
func (m *Module) routes() []creationhttp.Route {
	return []creationhttp.Route{
		...
		{Method: "GET", Path: "/creation/inspiration/assets/{assetID}/thumbnail-url", Guard: creationhttp.GuardAdmin, Handler: m.publications.GetAdminAssetThumbnailURL},
		{Method: "GET", Path: "/creation/inspiration/assets/{assetID}/preview-url", Guard: creationhttp.GuardAdmin, Handler: m.publications.GetAdminAssetPreviewURL},
		...
		{Method: "GET", Path: "/creation/publications/{publicationID}/thumbnail-url", Handler: m.publications.GetPublicationThumbnailURL},
		{Method: "GET", Path: "/creation/publications/{publicationID}/preview-url", Handler: m.publications.GetPublicationPreviewURL},
