...
// ObjectStorageBlobStoreFactory constructs the active provider adapter from decrypted credentials.
// Callers erase their plaintext buffer immediately after the synchronous call returns.
type ObjectStorageBlobStoreFactory func(ObjectStorageLocation, ObjectStorageCredentials) (ObjectStorageBlobStore, error)
