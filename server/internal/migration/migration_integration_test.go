...
// is applied exactly once. Real-database opt-in follows the uniform contract:
// without NEVIX_IDENTITY_INTEGRATION_REQUESTED a missing environment skips;
// with the flag set a missing environment fails.
package migration
