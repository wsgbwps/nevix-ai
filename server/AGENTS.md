...
- When distinct responsibility clusters emerge inside a simple Module, split them into responsibility-named sub-packages (identity: `verification/` + `outbox/`) with `module.go` remaining the composition surface
